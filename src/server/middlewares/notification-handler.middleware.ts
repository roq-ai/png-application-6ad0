...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'customer.update': {
    roles: ['business-owner', 'account-manager'],
    key: 'customer-update-profile',
    tenantPath: ['company', 'user', 'customer'],
    userPath: [],
  },
  'meter_reading.create': {
    roles: ['business-owner', 'account-manager'],
    key: 'meter-reading-input',
    tenantPath: ['company', 'user', 'customer', 'meter_reading'],
    userPath: [],
  },
  'bill.create': {
    roles: ['business-owner', 'account-manager', 'customer'],
    key: 'bill-calculated',
    tenantPath: ['company', 'user', 'customer', 'bill'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['business-owner', 'account-manager', 'meter-reader'];
