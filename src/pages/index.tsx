...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`PNG Application`}</title>

        <meta
          name="description"
          content="Experience simplicity and accuracy with PNG Application - your ultimate solution for Gas Meter Reading and Bill Generation based on precise calculations."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1622801185864-874be8248594?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxnYXMlMjBtZXRlcnxlbnwwfHx8fDE2OTI3NjYyNDR8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@d_morgan?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Doris Morgan`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience simplicity and accuracy with PNG Application - your ultimate solution for Gas Meter Reading and Bill Generation based on precise calculations.`}
            </Text>
            <Box
