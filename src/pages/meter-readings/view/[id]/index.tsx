            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('meter_reading', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/meter-readings/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem
                  label="Reading Date"
                  text={
                    data?.reading_date ? format(parseISO(data?.reading_date as unknown as string), 'dd-MM-yyyy') : ''
                  }
                />

                <FormListItem label="Reading Value" text={data?.reading_value} />

                <FormListItem label="Bill Calculated" text={data?.bill_calculated} />
